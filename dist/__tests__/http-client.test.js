...
describe("HTTP GET Request", () => {
    ...
    it("should handle response error event", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect((0, http_client_main_1.fetchData)("http://example.com")).rejects.toThrow("Test response error");
    }));
    it("should handle network error event", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expect((0, http_client_main_1.fetchData)("http://example.com")).rejects.toThrow("Test network error");
    }));
});
